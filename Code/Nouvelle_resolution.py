...
class ORC(object):
    ...
    def evaluate(self):
        ...
        def cycle(T) :
            ...
            self.p_1 = least_squares(pitch_evap_I, x0=self.p_1_guess, bounds=(5000, 10**7)).x[0]
            self.p_4 = self.p_1
            ...
            self.p_2 = least_squares(pitch_evap_II, self.p_2_guess, bounds=(self.p_1, 10**7)).x[0]
            self.p_3 = self.p_2
        ...
        def pitch_evap_I_vrai(p1) :
            ...
            h_8_prim = self.h_8 - m_1/self.m_HF*(h_4 - h_1)
            T_8_prim = PropsSI("T","P",self.p_7,"H",h_8_prim,self.hot_fluid)

            return T_8_prim - self.T_3_prime - self.T_pinch_ex_I

        self.p_1 = least_squares(pitch_evap_I_vrai, x0=self.p_1_guess, bounds=(5000, 10**7)).x[0]
        ...
        def pitch_evap_II_vrai(p2) :
            ...
            h_7_prim = self.h_7 - m_2/self.m_HF*(h_3 - h_2)
            T_7_prim = PropsSI("T","P",self.p_7,"H",h_7_prim,self.hot_fluid)

            return T_7_prim - self.T_4_prime - self.T_pinch_ex_II

        self.p_2 = least_squares(pitch_evap_II_vrai, self.p_2_guess, bounds=(self.p_1, 10**7)).x[0]
