    ...
    def evaluate(self):
        ...
        def cycle(p_1_guess, p_2_guess, p_5_guess) : 
            ...
            def T_out_pumpII(T2_guess) :
                cp_average = self.CP_av(self.T_1 , T2_guess , self.p_1_guess , self.p_2_guess , self.fluid)
                
                return T2_guess - self.T_1 - (self.p_2_guess - self.p_1_guess) / (self.eta_pump_2 * cp_average)
