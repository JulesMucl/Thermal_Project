...
class ORC(object):
    ...
    def evaluate(self):
        ...
        def opti_T_surchauffe_sousref(T) : 
            T_surchauffe_3, T_surchauffe_4, T_sousref, T_8 = T

            T_4 = T_8 - T_surchauffe_4
            T_3 = self.T_7 - T_surchauffe_3


                #region ETAT 8
            self.p_8 = self.p_HF
            self.h_8 = PropsSI("H","T",T_8,"P",self.p_7,self.hot_fluid)
            self.s_8 = PropsSI("S","T",T_8,"P",self.p_7,self.hot_fluid)
            self.e_8 = self.exergie(self.h_8,self.s_8)
            self.x_8 = PropsSI("Q","T",T_8,"P",self.p_7,self.hot_fluid)
            ...
            def cycle(T) :
                ...
                self.T_6 = least_squares(pitch_cond,  x0 = self.T_11, bounds=(self.T_11, T1)).x[0]
                self.p_6 = PropsSI("P","T",self.T_6 + T_sousref,"Q",0,self.fluid)
                self.p_5 = self.p_6
            ...
            # Résolution
            self.T1, self.T2, self.T5 = least_squares(cycle, [T_1_guess, T_2_guess, T_5_guess], bounds = ([273.15 + 20,273.15 + 20,self.T_11],[T_8,self.T_7,273.15 + 120]), max_nfev=600).x
            ...
            self.p_1 = fsolve(pitch_evap_I_vrai, self.p_1_guess)[0]
            ...
            self.T_6 = least_squares(pitch_cond_vrai,  x0 = self.T_11, bounds=(self.T_11, self.T1)).x[0]
            self.p_6 = PropsSI("P","T",self.T_6 + T_sousref,"Q",0,self.fluid)
            self.h_6 = PropsSI("H","P",self.p_6,"T",self.T_6,self.fluid)
            ...
            self.liste_Pe.append(self.Pe)
            self.n += 1
            return - self.Pe

        self.T_surchauffe_3, self.T_surchauffe_4, self.T_sousref, self.T_8 = minimize(opti_T_surchauffe_sousref, x0=(10,10,1, (self.T_7 + self.T_9)/2), bounds=[(1, 20), (1,20), (1,20), (self.T_9 + 0.1, self.T_7 - 0.1 )], method='TNC').x
        ...
        print("T_sousref === ",self.T_sousref)
        print("T_8 === ",self.T_8)
